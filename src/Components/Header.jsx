      ...
      <header className="text-gray-600 body-font shadow-lg">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          >
            ...
            <span className="ml-3 text-xl">Tuatara</span>
          </Link>
          <nav className="md:ml-auto flex mx-auto flex-wrap items-center text-base justify-center">
            {navigations.map((navigation) => {
              return (
                <Link
                  key={navigation.id}
                  to={navigation.path}
                  className="mr-5 font-semibold hover:text-indigo-400"
                >
                  {navigation.name}
                </Link>
              );
